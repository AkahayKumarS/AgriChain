...
const Articles = ({ accounts }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex flex-col items-center py-12 sm:px-6 lg:px-8">
      {/* Article Form */}
      <div className="max-w-2xl w-full bg-gray-800 p-8 rounded-lg shadow-lg mb-12">
        <h2 className="mb-6 text-3xl font-bold text-lime-400">Add Article</h2>
        <form onSubmit={onSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              placeholder="Title"
              className="mt-1 p-3 w-full bg-gray-700 border border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-lime-500 focus:border-transparent text-gray-200"
            />
          </div>
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-300">
          ...
          <button
            type="submit"
            className="w-full bg-lime-500 text-white py-2 px-4 rounded-lg hover:bg-lime-600 focus:outline-none focus:ring-2 focus:ring-lime-500 focus:ring-opacity-50 transition duration-200"
          >
            Upload
          </button>
        </form>
